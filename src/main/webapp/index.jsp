...
<head>
  ...
  <title>Travis UIL Competition</title>
  <!-- Bootstrap -->
...
<header>
  <div class="jumbotron">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <h1 class="text-center"><%=request.getAttribute("name")%></h1>
          <p class="text-center">Welcome to the <%=request.getAttribute("name")%> Programming competition. To get started, log in and register!</p>
  ...
  <div class="container ">
    <div class="row">
      <div class="col-lg-4 col-md-6 col-sm-12 text-center">
        <a href="downloads/idk-8-windows-x64.zip"><img class="rounded-circle" alt="140x140" style="width: 140px; height: 140px;" src="images/epicdownloadbutton.png" data-holder-rendered="true"> </a>
        <h3>JDK 8 Windows x64</h3>
        <p>If you didn't come prepared, we gotchu.&nbsp;&nbsp;</p>
      </div>
      <div class="col-lg-4 col-md-6 col-sm-12 text-center">
        <a href="downloads/idk-8-windows-x32.zip"><img class="rounded-circle" alt="140x140" style="width: 140px; height: 140px;" src="images/epicdownloadbutton.png" data-holder-rendered="true"> </a>
    ...
    <div class="container">
      <div class="row">
        <div class="col-12">
          ...
          <p class="text-center"><b>I can't run the pc2team file!</b><br>Run the RunPC2Windows.bat file if you are on Windows and the RunPC2TeamMacOrLinux file if you are on Mac or Linux. If these files don't exist, contact the admin!</p>
          ...
          <p class="text-center"><b>I'm on Mac/Linux and I can't run the RunPC2TeamMacOrLinux file!</b><br>To run the RunPC2TeamMacOrLinux file on any linux based system (which includes Mac), you must open terminal type "cd " then drag the bin folder from the recently download pc2-9.6.0 into the terminal window, or you can type out the path to the bin folder. In the terminal window you should end up with a command that says "cd ".../pc2-9.6.9/bin"" (the ... is just short for a bunch of other text). Press enter. Now type "chmod +x RunPC2TeamMacOrLinux" and press enter. Now you can open the file!</p>
